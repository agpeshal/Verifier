...
def analyze(net, inputs, eps, true_label):
    if 'fc' in args.net:
        model = deeppoly_fc.Model(net, eps=eps, x=inputs, true_label=true_label, args=args)
    elif 'conv' in args.net:
        model = deeppoly_conv.Model(net, eps=eps, x=inputs, true_label=true_label, args=args)
